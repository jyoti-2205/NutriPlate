/** Keep in sync with backend/database/foodImages.js */
...
export function getFoodImageUrl(name) {
  return FOOD_IMAGE_URLS[name] || foodish('burger', 1);
}

export function resolveFoodImageSrc(_src, foodName) {
  return getFoodImageUrl(foodName);
}
